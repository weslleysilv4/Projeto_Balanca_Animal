...
public class Cadastro_Equino extends javax.swing.JFrame {
    ...
    public void insEquino(){
        try{
            ...
            if (btn_DoencaSim.isSelected()) cav.setDoencaAnimal(cx_DoencaAnimal.getText());
            else if (btn_DoencaNao.isSelected()) cav.setDoencaAnimal("Sem doenças");
            else cav.setDoencaAnimal("Sem doenças");
